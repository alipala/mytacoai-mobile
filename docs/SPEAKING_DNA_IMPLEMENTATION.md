...
## Mobile App Visual Strategy

### Where Speaking DNA Lives in the App

```
┌─────────────────────────────────────────────────────────────────────────────┐
│                        SPEAKING DNA TOUCHPOINTS                              │
├─────────────────────────────────────────────────────────────────────────────┤
│                                                                             │
│  ┌─────────────┐  ┌─────────────┐  ┌─────────────┐  ┌─────────────────────┐│
│  │   LEARN     │  │   TODAY     │  │ CHALLENGES  │  │      PROFILE        ││
│  ├─────────────┤  ├─────────────┤  ├─────────────┤  ├─────────────────────┤│
│  │             │  │             │  │             │  │ ★ MAIN DNA SCREEN ★ ││
│  │ Mini DNA    │  │ "Session    │  │ DNA-based   │  │                     ││
│  │ Summary     │  │  Impact"    │  │ challenge   │  │ - Full DNA Helix    ││
│  │ Card        │  │ preview     │  │ unlocks     │  │ - Evolution Chart   ││
│  │             │  │             │  │ (future)    │  │ - Breakthroughs     ││
│  │ Entry point │  │             │  │             │  │ - Share Card        ││
│  │ to full DNA │  │             │  │             │  │                     ││
│  └─────────────┘  └─────────────┘  └─────────────┘  └─────────────────────┘│
│                                                                             │
│  ┌─────────────────────────────────────────────────────────────────────────┐│
│  │                    DURING/AFTER SESSIONS                                 ││
│  │  • Post-session: Breakthrough celebration modal (if detected)           ││
│  │  • Post-session: "DNA Updated" with impact preview                      ││
│  │  • Links to full DNA screen                                             ││
│  └─────────────────────────────────────────────────────────────────────────┘│
│                                                                             │
└─────────────────────────────────────────────────────────────────────────────┘
```
...
### 1. PROFILE TAB - Main DNA Screen (Primary Home)

This is where the full Speaking DNA experience lives. Add as a new screen accessible from Profile.

```
┌─────────────────────────────────────────┐
│ ←  Your Speaking DNA            [Share] │
├─────────────────────────────────────────┤
│                                         │
│         ╭─────────────────╮             │
│        ╱    🧬 DNA HELIX   ╲            │
...
│  │                                     ││
│  │  A deliberate learner who values    ││
│  │  accuracy and builds confidence     ││
│  │  through mastery.                   ││
│  │                                     ││
│  │  🎯 24 sessions  ⏱️ 87 minutes      ││
│  └─────────────────────────────────────┘│
│                                         │
│  ┌─────────┬───────────┬──────────────┐ │
│  │ Strands │ Evolution │ Breakthroughs│ │  ← Tab selector
│  └─────────┴───────────┴──────────────┘ │
│                                         │
│  ┌─────────────────────────────────────┐│
│  │ 🎵 Rhythm: Thoughtful Pacer         ││
│  │ ████████████░░░░  85 WPM            ││
│  │                                     ││
│  │ 💪 Confidence: Building  ↑          ││
│  │ ██████████░░░░░░  65%               ││
...
│  │ ████████░░░░░░░░  Intermediate      ││
│  │                                     ││
│  │ 🎯 Accuracy: Perfectionist          ││
│  │ ███████████████░  78%               ││
│  │                                     ││
│  │ 🧠 Learning: Persistent             ││
│  │ █████████████░░░  Challenge: 60%    ││
│  │                                     ││
│  │ 💜 Emotional: Slow Warmer           ││
│  │ ██████████████░░  End conf: 75%     ││
│  └─────────────────────────────────────┘│
│                                         │
│  Your Strengths                         │
...
### Evolution Tab (Within DNA Screen)

```
┌─────────────────────────────────────────┐
│  ┌─────────┬───────────┬──────────────┐ │
│  │ Strands │[Evolution]│ Breakthroughs│ │
│  └─────────┴───────────┴──────────────┘ │
│                                         │
...
│                                         │
│  ┌─────────────────────────────────────┐│
│  │ 📈 +15% confidence in 6 weeks       ││
│  │ Your rhythm consistency improved    ││
│  │ by 20% since you started!           ││
│  └─────────────────────────────────────┘│
│                                         │
...
### Breakthroughs Tab (Within DNA Screen)
...
│                                         │
│  ┌─────────────────────────────────────┐│
│  │ 🚀  Confidence Breakthrough!    NEW ││
│  │     Your confidence jumped from     ││
│  │     50% to 65% in one session!      ││
│  │     Jan 25, 2026                    ││
│  └─────────────────────────────────────┘│
│                                         │
│  ┌─────────────────────────────────────┐│
│  │ 📚  Vocabulary Explosion!           ││
│  │     Used 15 new words successfully  ││
│  │     Jan 20, 2026                    ││
│  └─────────────────────────────────────┘│
│                                         │
│  ┌─────────────────────────────────────┐│
│  │ 💪  Challenge Conqueror!            ││
│  │     Now accepting 60%+ challenges   ││
│  │     Jan 15, 2026                    ││
│  └─────────────────────────────────────┘│
│                                         │
│  ┌─────────────────────────────────────┐│
│  │ ⬆️  Level Up: Building!             ││
│  │     Graduated from 'hesitant' to    ││
│  │     'building' confidence!          ││
│  │     Jan 10, 2026                    ││
│  └─────────────────────────────────────┘│
│                                         │
...
### 2. PROFILE TAB - DNA Entry Card

Add a prominent card in the Profile tab that links to the full DNA screen:
...
│  ┌─────────────────────────────────────┐│
│  │  👤 Ali                             ││
│  │  Learning Dutch • A1 Level          ││
│  └─────────────────────────────────────┘│
│                                         │
│  ┌─────────────────────────────────────┐│
│  │ 🧬 YOUR SPEAKING DNA            →   ││  ← Tappable card
│  │                                     ││
│  │  ╭───╮                              ││
│  │  │🧬 │  "The Thoughtful Builder"    ││
│  │  ╰───╯                              ││
...
│  │  ████████░░  Confidence: 65%  ↑     ││
│  │                                     ││
│  │  🚀 2 breakthroughs this month      ││
│  └─────────────────────────────────────┘│
│                                         │
│  Recent Practice Sessions               │
│  ┌─────────────────────────────────────┐│
│  │ Today: Describing Places   5:00 ✓  ││
│  │ Yesterday: Weather talk    5:00 ✓  ││
│  └─────────────────────────────────────┘│
│                                         │
...
### 3. LEARN TAB - Mini DNA Card

Add a smaller DNA summary card near "Choose Your Session":
...
### 4. POST-SESSION - DNA Impact Summary

Add to the session completion screen:
...
### 5. BREAKTHROUGH CELEBRATION MODAL

Show when a breakthrough is detected post-session:
...
### 6. SHAREABLE DNA CARD

For social sharing (Instagram, Twitter, WhatsApp):
...
│  │                                     ││
│  │   Learning Dutch for 6 weeks        ││
│  │   24 sessions • 87 minutes          ││
│  │                                     ││
│  │        ─────────────────            ││
│  │           MyTaco AI                 ││
│  │     Discover your Speaking DNA      ││
│  │                                     ││
│  └─────────────────────────────────────┘│
│                                         │
│   Share to:                             │
...
For users without DNA profile yet:
...
│  ┌─────────────────────────────────────┐│
│  │                                     ││
│  │   Your Speaking DNA is waiting      ││
│  │   to be discovered!                 ││
│  │                                     ││
│  │   Complete a Speaking Assessment    ││
│  │   to create your unique speaking    ││
│  │   fingerprint.                      ││
│  │                                     ││
│  └─────────────────────────────────────┘│
│                                         │
...
│                                         │
│  ┌─────────────────────────────────────┐│
│  │  Or complete 3 practice sessions    ││
│  │  to start building your DNA         ││
│  └─────────────────────────────────────┘│
│                                         │
└─────────────────────────────────────────┘
```
...
### Color Palette for DNA Strands

```typescript
const STRAND_COLORS = {
  rhythm:     '#FF6B6B',  // Coral red
  confidence: '#4ECDC4',  // Teal
  vocabulary: '#45B7D1',  // Sky blue
  accuracy:   '#96CEB4',  // Sage green
  learning:   '#FFEAA7',  // Warm yellow
  emotional:  '#DDA0DD',  // Plum purple
};
```
...
|---------|---------|-------|
| DNA Helix Animation | `react-native-reanimated` | Smooth 60fps rotation |
| Charts | `react-native-chart-kit` | Evolution line charts |
| Confetti | `react-native-confetti-cannon` | Breakthrough celebrations |
| Share Cards | `react-native-view-shot` | Capture DNA card as image |
| Gradients | `react-native-linear-gradient` | Progress bar fills |
...
| Priority | Component | Location | Effort | Impact |
|----------|-----------|----------|--------|--------|
| 1️⃣ | DNA Profile Screen | New screen from Profile | Medium | High |
| 2️⃣ | DNA Card in Profile | Profile tab | Small | High |
| 3️⃣ | Breakthrough Modal | Post-session overlay | Small | High |
| 4️⃣ | Post-Session Impact | Session summary | Small | Medium |
| 5️⃣ | Mini DNA Card | Learn tab | Small | Medium |
| 6️⃣ | Shareable DNA Card | DNA screen | Medium | Medium |
| 7️⃣ | Evolution Charts | DNA screen tab | Medium | Medium |
| 8️⃣ | Empty State | DNA screen | Small | Low |
...
// DNA Card component for Profile/Learn tabs
const DNACard = ({ onPress }: { onPress: () => void }) => (
  <TouchableOpacity style={styles.dnaCard} onPress={onPress}>
    <DNAIcon />
    <View>
      <Text style={styles.archetype}>"The Thoughtful Builder"</Text>
      <ProgressBar value={0.65} color={STRAND_COLORS.confidence} />
      <Text style={styles.breakthroughHint}>🚀 2 breakthroughs this month</Text>
    </View>
    <ChevronRight />
  </TouchableOpacity>
);
