...
export const styles = StyleSheet.create({
  ...
  secondaryCardNew: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(26, 47, 58, 0.6)',
    borderRadius: 16,
    padding: 16,
    gap: 12,
    borderWidth: 1.5,
  ...
  primaryCardNew: {
    ...
    borderRadius: 20,
    overflow: 'hidden',
    backgroundColor: 'rgba(26, 47, 58, 0.8)',
    shadowColor: '#14B8A6',
    shadowOffset: { width: 0, height: 8 },
    shadowOpacity: 0.35,
    shadowRadius: 16,
  ...
  usageLimitsBanner: {
    flexDirection: 'row',
    alignItems: 'center',
    backgroundColor: 'rgba(255, 169, 85, 0.1)',
    borderRadius: 12,
    paddingHorizontal: 14,
    paddingVertical: 12,
    gap: 10,
    borderWidth: 1,
    borderColor: 'rgba(255, 169, 85, 0.3)',
  },
  usageLimitsText: {
    fontSize: 14,
    fontWeight: '600',
  ...
  upgradeLinkContainer: {
    ...
    alignItems: 'center',
    justifyContent: 'center',
    backgroundColor: 'rgba(255, 214, 58, 0.1)',
    borderRadius: 14,
    paddingVertical: 14,
    paddingHorizontal: 18,
    gap: 10,
